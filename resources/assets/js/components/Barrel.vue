	  ...
	  data(){
	    return {
	      ...
	      addresses: [
			...
			'проспект Соборний 8 (р-н Автовокзал)', 
			'вул. Українська 52Д', 
			'вул. Барикадна 58Г',
			'вул. Миколи Краснова 26А',
		  ],
	      advantages: [
			'Ціна талона нижча! *вартість талону ЗАВЖДИ МЕНША від цін на паливо, які ви бачите на АЗК.', 
			'Ціна фіксована! *ідеальна можливість спланувати свій бюджет.', 
			'Термін дії талону-30 днів! *скористуйтесь талоном протягом місяця на будь-якій заправці в мережі АЗК BARREl.',
			'Хочеш дешевше? Купуй талони!',
		  ],
	      options: {
	      	rewind : true,
	      	type: 'loop',
